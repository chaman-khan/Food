...
import { View, Text, TextInput, TouchableOpacity, KeyboardAvoidingView, ScrollView, Image,SafeAreaView,Alert } from 'react-native';
            ...
            <SafeAreaView style={{flex:1,backgroundColor:'#FFFFFF'}} contentContainerStyle={{ flexGrow: 1 }}>
                ...
                <View style={styles.Display}>
                    <View style={styles.Hearder_Box}>
                        ...
                        <Text style={styles.Welcome_Text}>Welcome Sign In to Your Account.</Text>
                    </View>
                    <View style={styles.Input_Box}>
                        <View style={styles.Email_Box}>
                            ...
                            {
                                emailError ? <Text style={styles.Error_Text}>* Enter valid Email</Text> : null
                            }
                        </View>
                    ...
                    <View style={styles.Forgot_Box}>
                        <Text style={styles.Help_text}>You need help accessing the account Password?</Text>
                        <TouchableOpacity onPress={()=>navigation.navigate('Recover Screen')}>
                            <Text style={styles.Recover_Text}>Recover it</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <TouchableOpacity style={styles.Google_Box} >
                        <Image style={styles.Google_Png} source={require('../Images/google.png')} />

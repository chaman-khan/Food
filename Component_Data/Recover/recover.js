    ...
    return (
        <View style={styles.Display}>
            <View style={styles.Png_Box}>
                <Image style={styles.Png} source={require('../Images/privacy.png')} />
            </View>
            <View style={styles.Text_Box}>
                <Text style={styles.Text1}>Forgot Password</Text>
                <Text style={styles.Text2}>Enter your Email we will send you 6 digit verification code.</Text>
            </View>
            <View style={styles.Email_Box}>
                <Text style={styles.Email_Text}>Email</Text>
                <View style={styles.Email_Input_Box}>
                    <Image style={styles.Mail_png} source={require('../Images/mail.png')} />
                    <TextInput
                ...
                {
                    emailEror ? (<Text style={styles.Error_Text} > * Enter valid email</Text>) : null
                }
            </View>

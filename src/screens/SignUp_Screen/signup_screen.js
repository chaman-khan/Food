...
import { Text, View, Image, TextInput, TouchableOpacity, Alert, ScrollView, KeyboardAvoidingView, SafeAreaView } from 'react-native';
...
const SignUp_Screen = ({ navigation }) => {
    ...
    return (
        ...
        >
            <SafeAreaView style={{ flex: 1, backgroundColor: '#FFFFFF' }} contentContainerStyle={{ flexGrow: 1 }}>
                <ScrollView>
                    <View style={styles.Display} >
                        <View style={styles.Png_Box}>
                            <Image source={require('../Images/heart.png')} style={styles.png} />
                        </View>
                        <View style={styles.Text_Box}>
                            <Text style={styles.Text1}>Sign Up</Text>
                            <Text style={styles.Text2}>Join the Food Care app and Never Miss a Celebration!</Text>
                        </View>
                        ...
                        <View style={styles.User_Box}>
                            ...
                            <View style={styles.User_Input_Container}>
                                <Image source={require('../Images/email.png')} style={styles.UserIcon} />
                                <TextInput
                        ...
                        <View style={styles.Location_Box}>
                            ...
                            <TouchableOpacity style={styles.Location} activeOpacity={0.5}>
                                ...
                                <Image source={require('../Images/Location_mark.png')} style={{ width: 18, height: 18, marginRight: 20 }}></Image>
                            </TouchableOpacity>

                        </View>
                        {
                            value == '1' ? <View style={styles.Button_Box}>
                                <TouchableOpacity activeOpacity={0.7} style={styles.Button} onPress={handleSignUp} >
                                    <Text style={styles.Sign_Up_Text} >Sign up</Text>
                                </TouchableOpacity>
                            </View> : <View style={styles.Button_Box}>
                                <TouchableOpacity activeOpacity={0.7} style={styles.Button} onPress={handleSignUp} >
                        ...
                        <View style={styles.SignIn_Box}>
                            ...
                            <TouchableOpacity style={styles.SignIn_Button} onPress={() => navigation.navigate('Login')}>

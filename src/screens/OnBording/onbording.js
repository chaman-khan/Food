    ...
    if (currentIndex === 0) {
      return (
        <View style={Styles.Slide_Inner_View}>
          ...
          <View style={Styles.Text_Box}>
            ...
            <Text style={Texts.Slide_Text2}>
              To get started, please follow the steps below to make your
              donation securely and easily.
            </Text>
          </View>
        </View>
      );
      ...
      return (
        <View style={Styles.Slide_Inner_View}>
          ...
          <View style={Styles.Text_Box}>
            ...
            <Text style={Texts.Slide_Text2}>
              Your contribution will have a lasting impact on the lives of those
              we serve.
            </Text>
          </View>
        </View>
      ...
      return (
        <View style={Styles.Slide_Inner_View}>
          ...
          <View style={Styles.Text_Box}>
            <Text style={Texts.Slide_Text1}>
              Be the hero in someone's story today.
            </Text>
            <Text style={Texts.Slide_Text2}>
              Thank you for choosing to make a difference! Your support helps us
